...
function TodoShow({ todo, onDelete, onEdit, onComplete }) {
        ...
        <div className="grid grid-cols-12">
            <div className="col-start-2 col-end-12 md:col-start-3 md:col-end-11 xl:col-start-4 xl:col-end-10">
                <div className="Todo-Show">
                    {editMode ? (
                        <div className="alt pt-5 px-3">
                            <form onSubmit={handleEditSubmit} className="flex items-center">
                                <label htmlFor="editTodo" className="sr-only">Edit</label>
                                <div className="relative w-full pr-3">
                                    <input type="text" onChange={handleEditTodoChange} value={newTodo} id="editTodo" className="bg-transparent text-m rounded-lg border border-slate-800 font-medium text-gray-300 focus:ring-blue-500 focus:border-blue-500 block w-full pl-5 p-3" required />
                                </div>
